import { AdminAddController } from "../../../adapters/controllers/AdminController/adminAddController";
...
import { AdminAddUseCase } from "../../../useCase/admin/AdminAddUseCase";
...
const adminAddUsecase=new AdminAddUseCase(adminReppsitory)
export const addUserController=new AdminAddController(adminAddUsecase)
